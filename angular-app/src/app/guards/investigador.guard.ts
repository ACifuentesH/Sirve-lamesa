...
//
// Antes /investigadores (entonces /admin, renombrada en issue #34) era una ruta
// abierta: cualquiera con la URL veía el panel y exportaba el estudio. El guard es
// la primera puerta, no la única: aunque alguien se la salte, el RLS no le entrega
// ni una fila sin un JWT autorizado.
